...
func (c *Cluster) CreateInstance() error {
	...
	// Start the mon pods
	c.mons = mon.New(c.context, c.Namespace, c.Spec.DataDirHostPath, c.Spec.VersionTag)
	...
	c.apis = api.New(c.context, c.Namespace, c.Spec.VersionTag)
	err = c.apis.Start()
	if err != nil {
	...
	// Start the OSDs
	c.osds = osd.New(c.context, c.Namespace, c.Spec.VersionTag, c.Spec.Storage, c.Spec.DataDirHostPath)
	err = c.osds.Start()
	if err != nil {
